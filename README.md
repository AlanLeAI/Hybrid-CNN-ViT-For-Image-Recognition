...
`python train_cifar10.py --net cnnvit` # Train CNN1ViT

`python train_cifar10.py --net cnn2vit` # Train CNN2ViT

`python train_cifar10.py --net cnn3vit` # Train CNN3ViT

`python train_mnist.py --net cnnvit` # Train CNN1ViT

`python train_mnist.py --net cnn2vit` # Train CNN2ViT

`python train_mnist.py --net cnn3vit` # Train CNN3ViT
